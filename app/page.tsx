    ...
    <div>
      <section className="relative overflow-hidden border-b border-line bg-dark text-white">
        ...
        <div className="container-shell relative py-20 md:py-24" data-gsap-stagger>
          <div className="grid gap-12 lg:grid-cols-[0.94fr_1.06fr] lg:items-center">
              ...
              <div className="mt-12 flex items-center gap-4 border-t border-white/20 pt-8">
                <div className="flex -space-x-3">
                  {["AWS", "GC", "AZR"].map((item) => (
                    <div
                      key={item}
                      className="grid h-10 w-10 place-items-center rounded-full border border-white/20 bg-dark text-[0.62rem] text-white"
                    >
                      {item}
                    </div>
                ))}
            ...
            <div className="relative z-10" data-gsap-media>
      ...
      <section className="container-shell py-24">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-12" data-gsap-stagger>
          <article className="stitch-card md:col-span-8 p-8">
          ...
          <article className="stitch-card md:col-span-4 p-8">
          ...
          <article className="stitch-card md:col-span-8 grid gap-8 p-8 md:grid-cols-[1fr_auto_1fr]">
            <div>
